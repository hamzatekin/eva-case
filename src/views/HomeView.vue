    ...
    <main>
        ...
        >
                                ...
                                <ul class="nav navbar-nav bookmark-icons">
                                    ...
                                    <li class="nav-item d-none d-lg-block">
                                        <a
                                            ...
                                            title="Todo"
                                            ><i
                                                class="ficon feather icon-check-square"
                                            ></i
                                        ></a>
                                    </li>
                                    <li class="nav-item d-none d-lg-block">
                                        <a
                                            ...
                                            title="Chat"
                                            ><i
                                                class="ficon feather icon-message-square"
                                            ></i
                                        ></a>
                                    </li>
                                    <li class="nav-item d-none d-lg-block">
                                    ...
                                    <li class="nav-item d-none d-lg-block">
                                        <a
                                            ...
                                            title="Calendar"
                                            ><i
                                                class="ficon feather icon-calendar"
                                            ></i
                                        ></a>
                                    </li>
                                </ul>
                                <ul class="nav navbar-nav">
                                    <li class="nav-item d-none d-lg-block">
                                        <a class="nav-link bookmark-star"
                                            ><i
                                                class="ficon feather icon-star warning"
                                            ></i
                                        ></a>
                                        <div
                                            class="bookmark-input search-input"
                                        >
                                            <div class="bookmark-input-icon">
                                                <i
                                                    class="feather icon-search primary"
                                                ></i>
                                            </div>
                                            <input
                                            ...
                                            />
                                            <ul
                                                class="search-list search-list-bookmark"
                                            ></ul>
                                        </div>
                            ...
                            <ul class="nav navbar-nav float-right">
                                ...
                                <li class="nav-item d-none d-lg-block">
                                    <a class="nav-link nav-link-expand"
                                        ><i
                                            class="ficon feather icon-maximize"
                                        ></i
                                    ></a>
                                </li>
                                <li class="nav-item nav-search">
                                    <a class="nav-link nav-link-search"
                                        ><i
                                            class="ficon feather icon-search"
                                        ></i
                                    ></a>
                                ...
                                >
                                    <a
                                        ...
                                        data-toggle="dropdown"
                                        ><i
                                            class="ficon feather icon-shopping-cart"
                                        ></i
                                        ><span
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <div class="media">
                                                    ...
                                                    >
                                                        <img
                                                            src="../../../app-assets/images/pages/eCommerce/10.png"
                                                            width="75"
                                                            alt="Cart Item"
                                                        />
                                                    </div>
                                        ...
                                        <li class="dropdown-menu-footer">
                                            <a
                                                ...
                                                ><i
                                                    class="feather icon-shopping-cart align-middle"
                                                ></i
                                                ><span
                                                    class="align-middle text-bold-600"
                                                    >Checkout</span
                                                ></a
                                            >
                                        </li>
                                        <li class="empty-cart d-none p-2">
                                            Your Cart Is Empty.
                                        </li>
                                    </ul>
                                </li>
            ...
            <ul class="main-search-list-defaultlist d-none">
                ...
                <li
                    class="auto-suggestion d-flex align-items-center cursor-pointer"
                >
                    <a
                    ...
                    >
                        ...
                        <li class="nav-item">
                            <a href="app-calender.html"
                                ...
                                ><span class="menu-title" data-i18n="Calender"
                                    >Calender</span
                                ></a
                            >
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="#"
                                ...
                                ><span class="menu-title" data-i18n="Data List"
                                    >Data List</span
                                ><span
                            ...
                            <ul class="menu-content">
                                ...
                                <li>
                                    <a href="data-thumb-view.html"
                                        ><i class="feather icon-circle"></i
                                        ><span
                                            class="menu-item"
                                            data-i18n="Thumb View"
                                            >Thumb View</span
                                        ></a
                                    >
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="#"
                                ...
                                ><span class="menu-title" data-i18n="Content"
                                    >Content</span
                                ></a
                            >
                            <ul class="menu-content">
                        ...
                        <li class="nav-item">
                            <a href="colors.html"
                                ...
                                ><span class="menu-title" data-i18n="Colors"
                                    >Colors</span
                                ></a
                            >
                        </li>
                        <li class="nav-item">
                            <a href="#"
                                ...
                                ><span class="menu-title" data-i18n="Icons"
                                    >Icons</span
                                ></a
                            >
                            <ul class="menu-content">
                        ...
                        <li class="nav-item">
                            <a href="#"
                                ...
                                ><span class="menu-title" data-i18n="Card"
                                    >Card</span
                                ></a
                            >
                            <ul class="menu-content">
                        ...
                        <li class="nav-item">
                            <a href="#"
                                ...
                                ><span class="menu-title" data-i18n="Components"
                                    >Components</span
                                ></a
                            >
                            <ul class="menu-content">
                                ...
                                <li>
                                    <a href="component-navs-component.html"
                                        ><i class="feather icon-circle"></i
                                        ><span
                                            class="menu-item"
                        ...
                        <li class="nav-item">
                            <a href="table.html"
                                ...
                                ><span class="menu-title" data-i18n="Table"
                                    >Table</span
                                ></a
                            >
                        </li>
                        <li class="nav-item">
                            <a href="table-datatable.html"
                                ...
                                ><span class="menu-title" data-i18n="Datatable"
                                    >Datatable</span
                                ></a
                            >
                        </li>
                        <li class="nav-item">
                            <a href="table-ag-grid.html"
                                ><i class="feather icon-grid"></i
                                ><span class="menu-title" data-i18n="ag-grid"
                                    >agGrid Table</span
                                ><span
                                    class="badge badge badge-primary badge-pill float-right mr-2"
                                    >New</span
                        ...
                        <li class="nav-item">
                            <a href="page-faq.html"
                                ...
                                ><span class="menu-title" data-i18n="FAQ"
                                    >FAQ</span
                                ></a
                            >
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="page-search.html"
                                ...
                                ><span class="menu-title" data-i18n="Search"
                                    >Search</span
                                ></a
                            >
                        </li>
                        <li class="nav-item">
                            <a href="page-invoice.html"
                                ...
                                ><span class="menu-title" data-i18n="Invoice"
                                    >Invoice</span
                                ></a
                            >
                        </li>
                        <li class="nav-item">
                            ...
                            <ul class="menu-content">
                                <li>
                                    <a
                                        href="../../../starter-kit/ltr/vertical-menu-template/sk-layout-2-columns.html"
                                        ><i class="feather icon-circle"></i
                                        ><span
                                            class="menu-item"
                                            data-i18n="2 columns"
                                ...
                                <li>
                                    <a
                                        href="../../../starter-kit/ltr/vertical-menu-template/sk-layout-fixed-navbar.html"
                                        ><i class="feather icon-circle"></i
                                        ><span
                                            class="menu-item"
                                ...
                                <li>
                                    <a
                                        href="../../../starter-kit/ltr/vertical-menu-template/sk-layout-floating-navbar.html"
                                        ><i class="feather icon-circle"></i
                                        ><span
                                            class="menu-item"
                                            data-i18n="Floating navbar"
                                ...
                                <li>
                                    <a
                                        href="../../../starter-kit/ltr/vertical-menu-template/sk-layout-fixed.html"
                                        ><i class="feather icon-circle"></i
                                        ><span
                                            class="menu-item"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="menu-content">
                                ...
                                <li>
                                    <a href="page-not-authorized.html"
                                        ><i class="feather icon-circle"></i
                                        ><span
                                            class="menu-item"
                        ...
                        <li class="nav-item">
                            <a href="#"
                                ...
                                ><span class="menu-title" data-i18n="Charts"
                                    >Charts</span
                                ><span
                        ...
                        <li class="nav-item">
                            <a href="ext-component-toastr.html"
                                ><i class="feather icon-zap"></i
                                ><span class="menu-title" data-i18n="Toastr"
                                    >Toastr</span
                                ></a
                            >
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="ext-component-file-uploader.html"
                        ...
                        <li class="nav-item">
                            <a href="ext-component-quill-editor.html"
                        ...
                        <li class="nav-item">
                            <a href="ext-component-tour.html"
                                ><i class="feather icon-info"></i
                                ><span class="menu-title" data-i18n="Tour"
                                    >Tour</span
                                ></a
                            >
                        </li>
                        <li class="nav-item">
                            <a href="ext-component-clipboard.html"
                                ><i class="feather icon-copy"></i
                                ><span class="menu-title" data-i18n="Clipboard"
                                    >Clipboard</span
                                ></a
                            >
                        </li>
                        <li class="nav-item">
                            <a href=" ext-component-plyr.html"
                        ...
                        <li class="nav-item">
                            <a href="ext-component-context-menu.html"
                        ...
                        <li class="nav-item">
                            <a href="ext-component-swiper.html"
                                ...
                                ><span class="menu-title" data-i18n="swiper"
                                    >swiper</span
                                ></a
                            >
                        </li>
                        <li class="nav-item">
                            <a href="ext-component-i18n.html"
                                ...
                                ><span class="menu-title" data-i18n="l18n"
                                    >l18n</span
                                ></a
                            >
                        </li>
